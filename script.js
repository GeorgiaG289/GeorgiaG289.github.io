...
const RESOURCES_DATA = {
    "代码编写": {
        ...
        links: [
            ...
            { name: "Cursor‌（需科学上网）",url: "https://www.cursor.so/", description: "功能：AI编程助手，支持代码补全、错误修复、代码解释等功能。\n特点：界面简洁，操作直观，适合快速编程和调试。\n缺点：对复杂项目的理解和处理能力有限，且部分功能需要付费订阅。\n使用技巧：在编写代码时利用其错误修复功能快速定位和解决问题；使用代码解释功能帮助理解不熟悉的代码片段。" },
            { name: "TRAe‌", url: "https://www.trae.cn/", description: "字节出品，对标 Cursor，支持代码生成/补全/优化，可免费获取 Claude 的能力，对预算有限的开发者友好。‌‌" }
        ]
    },
    ...
    "图像生成": {
        ...
        links: [
            ...
            { name: "即梦 AI 1.5 Pro‌", url: "https://www.jimeng.ai/", description: "字节跳动旗下，对中文提示词理解好，生成亚洲人脸自然，支持文生图及图生视频，新用户送 800 秒额度。" },
            { name: "Midjourney（需科学上网）", url: "https://www.midjourney.com/", description: "功能：通过文本提示生成高质量艺术图像，支持多种风格和细节控制。\n特点：在艺术创作领域表现出色，生成的图像具有独特的美学风格和丰富的细节。\n缺点：需要通过Discord平台使用，学习曲线较陡；免费用户生成次数有限。\n使用技巧：利用其丰富的参数设置（如风格、细节等级、色彩模式等）来微调生成结果，尝试不同的提示词组合以获得最佳效果。" },
            { name: "DALL·E 3（需科学上网）", url: "https://openai.com/dall-e-3", description: "DALL·E 3是OpenAI推出的顶级文生图模型，核心优势是能像人类一样精准理解复杂的自然语言描述，生成细节丰富、排版准确的高质量图像，并深度集成在ChatGPT中使用" },
            { name: "Dribbble", url: "https://dribbble.com/", description: "（非AI工具）全球设计师作品展示" },
            { name: "Pexels", url: "https://www.pexels.com/zh-cn/", description: "（非AI工具）免费高质量图片" }
        ]
    },
    "视频生成":{
        icon:"📽️",
    ...
    "办公效率": {
        ...
        links: [
            ...
            { name: "Notion AI（需科学上网）", url: "https://www.notion.so/product/ai", description: "功能：集成在Notion中的AI助手，支持文本生成、总结、翻译、任务管理等功能。\n特点：无缝集成在Notion的笔记和项目管理环境中，适合个人和团队使用。\n缺点：作为通用AI助手，某些专业领域的生成质量可能不如专用工具。\n使用技巧：利用其总结功能快速提炼会议记录或长文档的关键信息；使用任务管理功能自动生成待办事项列表。" },
            { name: "ProcessOn", url: "https://www.processon.com/", description: "在线流程图思维导图" },
            { name: "FlowPix‌", url: "https://www.flowpix.cn/", description: "专注海外社交媒体与高端品牌内容生成，以“提示词 + 工作流”为核心，支持文生图及多风格迁移，创作效率较传统模式提升千倍以上。‌‌‌" },
            { name: "Paraflow‌", url: "https://www.paraflow.cn/", description: "核心优势为“需求结构化拆解”，支持 Web 端与移动端多尺寸适配，设计稿可直接导出至 Figma，适合敏捷产研团队。‌‌‌" },
            { name: "n8n", url: "https://n8n.io/", description: "功能：开源自动化工具，支持连接数百种应用，实现工作流程自动化。\n特点：完全免费且开源，支持自定义工作流程和多种触发器，适合技术用户进行复杂的自动化设置。\n缺点：需要一定的技术背景来配置和维护，非技术用户可能会觉得上手较难。\n使用技巧：利用其丰富的社区资源和预设模板快速搭建常用的自动化流程，如自动数据同步、定时任务等。" },
            { name: "Zapier‌（需科学上网）", url: "https://zapier.com/", description: "功能：连接数百种应用，实现工作流程自动化。\n特点：操作简单，支持多种触发器和动作，适合非技术用户进行快速配置。\n缺点：部分高级功能需要付费订阅，且生成视频的质量和稳定性可能因输入提示词的复杂程度而有所波动。学习成本相对较高。\n使用技巧：利用其丰富的社区资源和预设模板快速搭建常用的自动化流程，如自动数据同步、定时任务等。" },
            { name: "Manus AI‌", url: "https://manus.ai/", description: "功能：真正的'AI Agent'，可自主搜索、阅读、整理信息并输出报告，适合市场、运营人员进行信息收集。‌‌\n特点：专注于文档处理，提供多样化的文档模板和格式支持，适合需要大量文档处理的用户。\n缺点：作为专注于文档的工具，在其他领域的功能可能不如综合性平台。\n使用技巧：利用其丰富的文档模板快速生成专业文档；使用总结功能提炼长文档的关键信息；利用翻译功能进行多语言文档处理。" },
    ...
    "3D建模": {
        ...
        links: [
            ...
            { name: "Kaedim", url: "https://www.kaedim3d.com/", description: "功能：从2D图像生成3D模型，支持多种风格和细节控制。\n特点：在游戏开发和虚拟现实领域表现出色，生成的模型具有较高的艺术性和实用性。\n缺点：对复杂场景和高精度模型的生成能力有限，且需要付费订阅。\n使用技巧：提供清晰的2D参考图，并在提示词中明确所需的风格和细节要求，以获得更符合预期的3D模型。" },
            { name: "LibLib AI‌", url: "https://liblib.ai/", description: "国版 SD，拥有创作者社区生态，内置众多风格模型及训练 LoRA 功能，兼具 AI 视频功能。‌‌" },
            { name: "FLUX‌", url: "https://www.flux.ai/", description: "SD 团队全新产品，生成速度更快（3-8 步出图），手指等细节生成更稳定，支持商用。" }
        ]
    },
    "学术研究": {
        icon: "📄",
        ...
        links: [
            ...
            { name: "Perplexity", url: "https://www.perplexity.ai/", description: "功能：具备联网能力的AI对话式搜索引擎。可直接回答复杂问题，并提供答案的来源链接。\n特点：适合快速获取信息和进行初步研究，提供多样化的答案来源。\n缺点：在需要极深度的专业领域分析时，可能不如专业数据库。\n使用技巧：提出具体且明确的问题，以获得更准确的答案；利用提供的来源链接进行进一步阅读和验证；开启“学术”或“写作”等专注模式以获得更相关的资料来源；对复杂问题可进行多轮追问。" },
            { name: "SciSpace Copilot", url: "https://www.typeset.io/copilot", description: "功能：AI论文写作助手，支持文献综述、数据分析、图表生成等功能。\n特点：专为学术写作设计，能帮助研究者快速生成高质量的学术内容。\n缺点：目前主要支持英文论文写作，对中文学术写作的适配可能不够完善。\n使用技巧：利用其文献综述功能快速梳理相关研究；使用数据分析和图表生成功能提升论文的可视化效果。" },
            { name: "Luma Ray2‌", url: "https://www.luma.ai/ray2", description: "功能：基于NeRF技术的3D重建工具，支持从多张图片生成高质量的3D模型。\n特点：在学术研究和视觉计算领域表现出色，生成的3D模型具有较高的细节和真实感。\n缺点：对输入图片的质量和数量要求较高，且处理时间较长。\n使用技巧：提供多角度、高质量的输入图片；在提示词中明确所需的细节和风格要求，以获得更符合预期的3D模型。" },
            { name: "NotebookLM‌", url: "https://ai.google.dev/notebook-lm", description: "功能：Google推出的AI笔记助手，能帮助用户整理和总结笔记内容，支持多模态输入。\n特点：集成在Google生态系统中，适合学生和研究人员使用，能自动提取关键信息并生成总结。\n缺点：目前处于测试阶段，功能可能不够完善，对非Google服务的兼容性有限。\n使用技巧：利用其多模态输入功能，将文本、图片等信息整合在一起；定期使用总结功能提炼笔记中的关键信息。" }
        ]
    },
    "音乐生成": {
        icon: "🎵",
        ...
        links: [
            ...
            { name: "Suno AI（需科学上网）", url: "https://www.suno.ai/", description: "功能：根据文本描述或输入的歌词，一键生成包含人声演唱、多种乐器和完整编曲的歌曲。\n特点：音乐生成领域的突破性工具，极大地降低了音乐创作的门槛。\n缺点：部分功能需要付费。对生成风格的精准控制仍有限，编曲复杂度可能不及专业音乐人。\n使用技巧：在描述中明确风格、情绪、乐器和节奏（如“一首 upbeat 的流行朋克歌曲，带有电吉他 riff”）；也可以尝试编写完整的歌词让其演绎。" }
        ]
    },
    "AI工作坊": {
        icon: "🧑🏻‍🏫",
        description: "使用/开发AI，科普视频与教程",
        links: [
            { name: "2026超好用的十大 AI 工具！", url: "https://www.bilibili.com/video/BV1wvDmBaETB/", description: "B站科普视频，介绍了2026年最实用的十大AI工具，涵盖文本生成、图像生成、视频生成、办公效率等多个领域，适合想要了解和使用AI工具的观众。" },
            { name: "研究生导师都在用的11款小工具", url: "https://m.bilibili.com/video/BV1xo4y1k7bB/", description: "B站科普视频，介绍了11款研究生导师常用的小工具，涵盖文献管理、数据分析、学术写作等方面，适合研究生和学术人员参考使用。" },
            { name:"始智AI", url:"wisemodel.cn", description:"功能：提供AI模型训练、部署和应用的全流程服务，支持多种框架和算法。\n特点：适合企业和开发者使用，提供定制化的AI解决方案。\n缺点：主要面向企业用户，个人用户可能需要一定的技术背景才能充分利用其功能。\n使用技巧：利用其丰富的API接口和工具集成到现有的工作流程中，以提升AI项目的开发效率和应用效果。" },
            { name: "Hugging Face Spaces（需科学上网）", url: "https://huggingface.co/spaces", description: "功能：提供一个平台让开发者和研究人员部署和分享他们的AI模型和应用。\n特点：支持多种框架（如TensorFlow、PyTorch等），用户可以轻松访问和使用各种AI模型。\n缺点：作为一个开放平台，模型的质量和稳定性可能参差不齐。\n使用技巧：利用其丰富的社区资源，寻找适合自己需求的模型；如果有能力，也可以自己部署模型与社区分享。" },
            { name: "Replicate（需科学上网）", url: "https://replicate.com/", description: "功能：提供一个平台让开发者部署和分享他们的AI模型，支持多种框架和语言。\n"}
        ]    
        }
    }
